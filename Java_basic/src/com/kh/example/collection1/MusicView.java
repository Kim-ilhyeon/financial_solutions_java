...
public class MusicView {
	...
	public void setMusic() {
		...
		Music oldMusic = mc.setMusic(oldTitle, new Music(newTitle, newSinger));
		
		if (oldMusic == null) {
			System.out.println("수정할 곡이 없습니다.");
		} else {
//			System.out.println(oldMusic.getSinger() + " - " + oldTitle + "의 값이 변경 되었습니다.");
			System.out.println(oldMusic.getSinger() + " - " + oldMusic.getTitle() + "으로 변경 되었습니다.");
		}
	}
